...
\fill[pop1] ($(leftAx) + (pop1) + (0,2) $) to[out=65,in=90] ++(.51,2.7) -- ++(0,-3) -- cycle;
\fill[pop1] ($(leftAx) + (pop1) + (popwidth) + (0,2)$) to[out=115,in=90] ++(-.51,2.7) -- ++(0,-3) -- cycle;
\fill[pop1] ($(leftAx) + (pop1) $) -- ++(2,0) -- ++(0,2) -- ++(-2,0) --  cycle;
